      ...
      <div className="bg-white shadow-lg p-5 rounded-3xl w-full max-w-screen-sm dark:bg-gray-600">
        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            <span className="text-gray-600 font-semibold -mx-1 dark:text-gray-400">In transit</span>
        ...
        <div className="relative">
          <div className="absolute bg-gray-200 w-full rounded-full h-2"></div>
          <div className="absolute bg-green-500 w-2/3 rounded-full h-2"></div>
        </div>
